...
class PurchaseOrderLine(models.Model):
    ...
    last_price1 = fields.Float('Last Purchase Harga Dolar', help="Shows the last purchase price of the product for selected supplier from the Past two Purchase order")
    last_price2 = fields.Float('Last Purchase Harga Per Unit', help="Shows the second last purchase price of the product for selected supplier from the Past two Purchase order")
    ...
    def onchange_product_id(self):
        ...
        for record in self:
            ...
            if len(final_list)>=1:
                ...
                record.last_price1 = last_price1.harga_dolar
            if len(final_list)>=2:
