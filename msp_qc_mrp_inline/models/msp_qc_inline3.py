...
# class MspMayorMinor3(models.Model):
#     _name = "msp.mayor.minor3"

#     name = fields.Char(string='name',)

class MspQcInline3(models.Model):
    _name = 'msp.qc.inline3'
    # _rec_name = 'nama_operator_id'

    def get_msp_qc_inline3_no(self):
        nama_baru = self.env['ir.sequence'].next_by_code('msp.qc.inline3.no')
        return nama_baru

    name = fields.Char(string='Id Inline 2',required=True,copy=False, default=get_msp_qc_inline3_no,readonly=True )
