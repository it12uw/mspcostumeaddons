...
class MspQcInlineGarment(models.Model):
    _name= "msp.qc.inline.garment"
    # _name = 'msp.qc.inline1'
    # _rec_name = 'nama_operator_id'

    def get_msp_qc_inline_garment_no(self):
        nama_baru = self.env['ir.sequence'].next_by_code('msp.qc.inline.garment.no')
        return nama_baru

    name = fields.Char(string='Id Inline Garment',required=True,copy=False, default=get_msp_qc_inline_garment_no,readonly=True )
    ...
    sugestion_9 = fields.Char(string='Sugestion 9',)
    sugestion_10 = fields.Char(string='Sugestion 10',)
