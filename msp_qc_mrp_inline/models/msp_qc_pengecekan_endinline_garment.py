...
class MspQcPengecekanInlineGarmen(models.Model):
    _name ='msp.qc.pengecekan.endinlinegarmen'
    # _name ='msp.qc.pengecekan_inlinegarmen'

    def get_msp_qc_pengecekan_endinlinegarmen_no(self):
        nama_baru = self.env['ir.sequence'].next_by_code('msp.qc.pengecekan.endinlinegarmen.no')
        return nama_baru

    name = fields.Char(string='Id Inline 2',required=True,copy=False, default=get_msp_qc_pengecekan_endinlinegarmen_no,readonly=True )
    ...
    defect_6  = fields.Char(string='Defect 5',)
    defect_7  = fields.Char(string='Defect 5',)
    ...
    quantity_6  = fields.Integer(string='Quantity 5',)
    quantity_7  = fields.Integer(string='Quantity 5',)
    ...
    status_6 = fields.Selection([('mayor',_('Mayor')),('minor',_('Minor')),('kritikal',_('Kritikal')),], string="Status", store=True,)
    status_7 = fields.Selection([('mayor',_('Mayor')),('minor',_('Minor')),('kritikal',_('Kritikal')),], string="Status", store=True,)