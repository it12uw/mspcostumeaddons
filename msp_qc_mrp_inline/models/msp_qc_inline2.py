...
# class MspMayorMinor2(models.Model):
#     _name = "msp.mayor.minor2"

#     name = fields.Char(string='name',)

class MspQcInline2(models.Model):
    _name = 'msp.qc.inline2'
    # _rec_name = 'nama_operator_id'

    def get_msp_qc_inline2_no(self):
        nama_baru = self.env['ir.sequence'].next_by_code('msp.qc.inline2.no')
        return nama_baru

    name = fields.Char(string='Id Inline 2',required=True,copy=False, default=get_msp_qc_inline2_no,readonly=True )
    ...
    # msp_qc_inline2_line_ids = fields.One2many('msp.qc.inline2.line','msp_qc_inline2_id',string=u'Defect Found',)
    ...
    # button_inline2 = fields.Integer(string='Telah Di Tekan',)
