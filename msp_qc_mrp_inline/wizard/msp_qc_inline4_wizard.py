...
# --------------------------- inline 20 ----------------------------------------------------
# class MspMayorMinor4Wizard(models.TransientModel):
#     _name = "msp.mayor.minor4"

#     name = fields.Char(string='name',)
    
class MspQcInline4Wizard(models.TransientModel):
    _name = "msp.qc.inline4.wizard"
    ...
    @api.multi
    def msp_qc_inline4_wizard(self, vals):
        # self._get_mengisi_jumlah_minor_qc()
        # self._get_mengisi_jumlah_kritikal_qc()
        # self._get_mengisi_jumlah_mayor_qc()
        obj_nilai = self.env['msp.qc.inline4'].create({
        ...
        return super(MspQcInline4Wizard, self).write(vals)
