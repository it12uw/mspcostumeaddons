...
# --------------------------- inline 20 ----------------------------------------------------
# class MspMayorMinor3Wizard(models.TransientModel):
#     _name = "msp.mayor.minor3"

#     name = fields.Char(string='name',)


class MspQcInline3Wizard(models.TransientModel):
    _name = "msp.qc.inline3.wizard"
    ...
    mrp_productioin_id = fields.Many2one(string=u'No MO', related='name.production_id', readonly=True,compute='_get_mengisi_jumlah_mayor_qc',store=True)
    keterangan = fields.Text(string='Keterangan',store=True,)
    # button_inline3 = fields.Integer(string='Telah Di Tekan',store=True,)
    # drop down =======================================================
    ...
    @api.multi
    def msp_qc_inline3_wizard(self, vals):
        # self._get_mengisi_jumlah_minor_qc()
        # self._get_mengisi_jumlah_kritikal_qc()
        # self._get_mengisi_jumlah_mayor_qc()
        obj_nilai = self.env['msp.qc.inline3'].create({
            ...
            # self._get_mengisi_jumlah_kritikal_qc()
            # self._get_mengisi_jumlah_mayor_qc()
        return super(MspQcInline3Wizard, self).write(vals)
