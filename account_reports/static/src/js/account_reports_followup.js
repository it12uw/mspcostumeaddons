flectra.define('account_reports.account_report_followup', function (require) {
'use strict';
...
var account_report_followup = account_report.extend({
    ...
    display_exp_note_modal: function(e) {
        ...
        new Dialog(this, {title: 'flectra', size: 'medium', $content: $content, buttons: [{text: 'Save', classes: 'btn-primary', close: true, click: save}, {text: 'Cancel', close: true}]}).open();
    },
