...
from flectra.tools.misc import formatLang, format_date, ustr
from flectra.tools.translate import _
import time
from flectra.tools import append_content_to_html, DEFAULT_SERVER_DATE_FORMAT
...
class report_account_followup_report(models.AbstractModel):
    ...
    def send_email(self, options):
        ...
        if email and email.strip():
            ...
            msg_id = partner.message_post(body=msg, subtype='account_reports.followup_logged_action', message_type='email')
    ...
    def print_followup(self, options, params):
        ...
        if partner_id:
            self.env['res.partner'].browse(partner_id).message_post(body=_('Follow-up letter printed'))
