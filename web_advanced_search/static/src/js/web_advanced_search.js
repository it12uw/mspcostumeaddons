...
flectra.define("web_advanced_search", function (require) {
    "use strict";
    ...
    SearchView.include({
         ...
         *
         * @param {FlectraEvent} event The target will get the dataset.
         */
        ...
        get_filter: function () {
            ...
            return {
                attrs: {
                    ...
                    // https://github.com/flectra/flectra/pull/25922
    ...
    FilterMenu.include({
         ...
         *
         * @param {FlectraEvent} event A `domain_selected` event from the dialog.
         */
