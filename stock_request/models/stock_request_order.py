...
class StockRequestOrder(models.Model):
    ...
    price_unit = fields.Float('Unit Price', digits=dp.get_precision('Product Price'), readonly=True, compute = '_compute_price_unit')
    ...
    def _compute_price_unit(self):
        for request in self:
            request.price_unit = request.product_id.product_tmpl_id.list_price