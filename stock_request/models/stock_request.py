...
class StockRequest(models.Model):
    ...
    order_ref = fields.Char(states={'draft': [('readonly', False)]}, readonly=True
    )
    ...
    def _compute_qty(self):
        for request in self:
            ...
            request.qty_cancelled = max(0, uom._compute_quantity(
                ...
                request.product_uom_id)) if request.allocation_ids else 0
            request.qty_left = max(0, uom._compute_quantity(
                request.product_qty - done_qty - request.qty_cancelled,
