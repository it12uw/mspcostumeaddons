...
class MisReportInstance(models.Model):
    ...
    display_column_description_date_format = fields.Char(
            string='Date Format',
            help='Define a special date format for the description with placeholders of python babel.',
    )
    ...
    def _compute_matrix(self):
        ...
        for period in self.period_ids:
            ...
            if period.mode == MODE_NONE:
                ...
                description = self._format_date(period.date_from, self.display_column_description_date_format)
            elif period.date_from and period.date_to:
                date_from = self._format_date(period.date_from, self.display_column_description_date_format)
                date_to = self._format_date(period.date_to, self.display_column_description_date_format)
