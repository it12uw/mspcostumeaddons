...
class ProductionBomReportReq(models.AbstractModel):
    ...
    """
    _name = 'report.manufacturing_bom_report_rekap.report_mrpbomorder_req'
    ...
    def get_report_values(self, docids, data=None):
        ...
        # return self.env["report"].render('manufacturing_bom_report_rekap.report_mrpbomorder_req', docargs)
        return docargs
