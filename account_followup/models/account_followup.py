...
class ResPartner(models.Model):
    ...
    def get_followup_table_html(self):
        ...
        if partner.unreconciled_aml_ids:
            ...
            report = self.env['report.account_followup.report_followup']
    ...
    latest_followup_level_id = fields.Many2one(
        'account_followup.followup.line', compute='_get_latest',
...
class AccountConfigSettings(models.TransientModel):
    ...
    def open_followup_level_form(self):
        res_ids = self.env['account_followup.followup'].search([], limit=1)
        return {
